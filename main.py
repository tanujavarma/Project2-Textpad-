...
main_application.title("Textpad editor")
#####################main menu###################################
#------------&&&&&&&&&&&&End main menu&&&&&&&&&------------------
main_menu=tk.Menu()
#file
...
save_as_icon=tk.PhotoImage(file='images/save_as.png')
...
clear_all_icon=tk.PhotoImage(file='images/clear_all.png')
find_icon=tk.PhotoImage(file='images/find.png')

edit=tk.Menu(main_menu, tearoff=False)

#View icons
tool_bar_icon=tk.PhotoImage(file='images/tool_bar.png')
status_bar_icon=tk.PhotoImage(file='images/status_bar.png')

view=tk.Menu(main_menu,tearoff=False)

#color icons
light_default_icon=tk.PhotoImage(file='images/light_default.png')
light_plus_icon=tk.PhotoImage(file='images/light_plus.png')
dark_icon=tk.PhotoImage(file='images/dark.png')
red_icon=tk.PhotoImage(file='images/red.png')
monokai_icon=tk.PhotoImage(file='images/monokai.png')
night_blue_icon=tk.PhotoImage(file='images/night_blue.png')
...
#align left
align_left_icon=tk.PhotoImage(file='images/align_left.png')
align_left_btn=ttk.Button(tool_bar,image=align_left_icon)
align_left_btn.grid(row=0,column=6,padx=5)

#align center
align_center_icon=tk.PhotoImage(file='images/align_center.png')
align_center_btn=ttk.Button(tool_bar,image=align_center_icon)
align_center_btn.grid(row=0,column=7,padx=5)


#align right
align_right_icon=tk.PhotoImage(file='images/align_right.png')
        ...
        if text_changed:
            ...
            if mbox is True:
                if url:
                    ...
                    content2=str(txt_editor.get(1.0,tk.END))
...
main_application.bind("<Control-Alt-n>",save_as)
